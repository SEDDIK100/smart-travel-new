...
import { setTripMood as setAction } from "@/redux/slices/tripSlices";
import { router } from "expo-router";
import HeaderQu from "@/components/HeaderQu";

const options = [
  { id: 1, label: "Relax", icon: "😌" },
  { id: 2, label: "Explore", icon: "🧭" },
  { id: 3, label: "Adventure", icon: "⚡" },
  { id: 4, label: "Nightlife", icon: "🎉" },
  { id: 5, label: "Cultural", icon: "🏛️" },
];
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#0d0d0d]">
      ...
      <View className="px-6 mb-4">
        <Text className="text-white text-2xl font-extrabold tracking-tight">Travel mood ?</Text>
        <Text className="text-gray-400 text-md mt-1">What vibe are you looking for</Text>
      </View>
          ...
          {options.map((item) => {
            ...
            return (
              <TouchableOpacity
                ...
                className={`w-[28%] py-4 rounded-2xl items-center border ${isActive 
