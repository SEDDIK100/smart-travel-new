...
import { setBudget as setAction } from "@/redux/slices/tripSlices";
...
const TripBudget = () => {
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#0d0d0d]">
      <HeaderQu linkPrv="/(screens)/(plan)/TripDuration" linkNext="/(screens)/(plan)/TripSummary" />
      ...
      <View className="px-6 mb-4">
        <Text className="text-white text-2xl font-extrabold tracking-tight">Your budget ?</Text>
        <Text className="text-gray-400 text-md mt-1">What s your budget level</Text>
      </View>
