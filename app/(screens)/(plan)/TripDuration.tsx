...
import { setTripDuration as setAction } from "@/redux/slices/tripSlices";
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#0d0d0d]">
      ...
      <View className="px-6 mb-4">
        <Text className="text-white text-2xl font-extrabold tracking-tight">How long ?</Text>
        <Text className="text-gray-400 text-md mt-1">How long is your trip</Text>
      </View>
